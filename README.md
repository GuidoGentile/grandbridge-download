...
- APK Android pubblico disponibile in downloads/GrandBridge-0.2.5-alpha.apk;
- Google configurato come accesso social; email e password restano disponibili;
- replay dei Simultanei FIGB pubblici disponibile dalla tessera associata al profilo; accesso FIGB con credenziali non ancora attivo;
- Facebook, Apple e pagamenti restano disabilitati finché mancano credenziali o accordi ufficiali.

L’APK 0.2.5-alpha è una build firmata per il collaudo e richiede l’autorizzazione all’installazione manuale sul dispositivo Android. Conserva l’identificativo com.grandbridge.app per aggiornare l’installazione precedente quando la firma coincide.
