...
- APK Android pubblico 0.4.2-beta.4 disponibile dalla release collegata alla landing page;
...
L’APK 0.4.2-beta.4 è una build firmata per il collaudo e richiede l’autorizzazione all’installazione manuale sul dispositivo Android. Conserva l’identificativo com.grandbridge.app per aggiornare l’installazione precedente quando la firma coincide.

## Aggiornamento dell’8 settembre 2026

Interfaccia verificata su 206 configurazioni simulate; adattamento automatico del bidding box; PAR e claim nel replay; cronologia e leggibilità delle licite migliorate.
...
- [APK 0.4.2-beta.4](https://github.com/GuidoGentile/grandbridge-download/releases/download/v0.4.2-beta.4/GrandBridge-0.4.2-beta.4.apk)
- [Release](https://github.com/GuidoGentile/grandbridge-download/releases/tag/v0.4.2-beta.4)
