...
- APK Android pubblico 0.4.2-alpha disponibile dalla release collegata alla landing page;
...
L’APK 0.4.2-alpha è una build firmata per il collaudo e richiede l’autorizzazione all’installazione manuale sul dispositivo Android. Conserva l’identificativo com.grandbridge.app per aggiornare l’installazione precedente quando la firma coincide.
