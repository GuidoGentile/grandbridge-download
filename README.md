...
- APK Android Server 0.4.2-beta.13 disponibile dalla release collegata alla landing page;
...
L’APK 0.4.2-beta.13-server è una build firmata per il collaudo e richiede l’autorizzazione all’installazione manuale sul dispositivo Android. Usa l’identificativo `com.grandbridge.app.server` e aggiorna l’installazione Server precedente quando la firma coincide.
...
- [APK 0.4.2-beta.13-server](https://github.com/GuidoGentile/grandbridge-download/releases/download/v0.4.2-beta.13-server/GrandBridge-server-0.4.2-beta.13.apk)
- [Release](https://github.com/GuidoGentile/grandbridge-download/releases/tag/v0.4.2-beta.13-server)
